...
return [
    ...
    */
    ...
    'pdok' => [
        ...
        'gebruiksfuncties_wms_url' => env('PDOK_GEBRUIKSFUNCTIES_WMS_URL', 'https://data.rivm.nl/geo/alo/wms'),
        'gebruiksfuncties_wms_layer' => env('PDOK_GEBRUIKSFUNCTIES_WMS_LAYER', 'rivm_bag_pandfuncties_actueel,rivm_bag_adresfuncties_actueel'),
